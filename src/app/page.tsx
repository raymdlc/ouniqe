  ...
  return (
    <main className="min-h-screen bg-[#f5f1ea] text-black">
      <section className="min-h-screen px-6 md:px-12 lg:px-20 py-8 flex flex-col">
        ...
        <div className="flex justify-between items-end text-xs uppercase tracking-[0.2em]">
          <span>Est. 2026</span>
          <span>Scroll ↓</span>
        </div>
      </section>

      <section id="journal" className="px-6 md:px-12 lg:px-20 py-24 border-t border-black/15">
        <div className="flex justify-between items-end mb-12">
          ...
          <a href="/journal" className="text-sm underline underline-offset-4">
            View all
          </a>
        </div>
        ...
        <div className="grid md:grid-cols-2 gap-8">
          ...
          <article>
            ...
            <h3 className="text-2xl">Looking at things differently.</h3>
          </article>
        </div>
      </section>

      <section id="gallery" className="px-6 md:px-12 lg:px-20 py-24 border-t border-black/15">
        <p className="text-xs uppercase tracking-[0.25em] mb-3">
          02 — Gallery
        </p>
      ...
      <section id="objects" className="px-6 md:px-12 lg:px-20 py-24 border-t border-black/15">
        <p className="text-xs uppercase tracking-[0.25em] mb-3">
          03 — Objects
        </p>
      ...
      <section id="about" className="px-6 md:px-12 lg:px-20 py-24 border-t border-black/15">
        <p className="text-xs uppercase tracking-[0.25em] mb-3">
          04 — About
        </p>

        <div className="grid md:grid-cols-2 gap-12">
          <h2 className="text-4xl md:text-6xl">Ouniqe_</h2>
